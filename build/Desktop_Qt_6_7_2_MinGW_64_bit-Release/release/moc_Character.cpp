...
Q_CONSTINIT static const uint qt_meta_data_CLASSCharacterENDCLASS[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Bool, QMetaType::UShort,    3,    4,
...
void Character::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->winOrLost((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<ushort>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Character::*)(bool , unsigned short int );
            if (_t _q_method = &Character::winOrLost; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Character::winOrLost(bool _t1, unsigned short int _t2)
{
